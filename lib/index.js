...
exports.rs256PEMVerify = exports.rs256PEMSign = exports.rs256JWKVerify = exports.rs256JWKSign = exports.parseToJSON = exports.jwtEncode = exports.jwtDecode = exports.hs256Verify = exports.hs256Sign = exports["default"] = exports.createHeaderPayload = exports.base64URLEncode = void 0;
  ...
  try {
    ...
    if (passphrase) {
      try {
        ...
        throw new Error("Failed to create the private key object needed create the RS256 signature. Tried without and with a passphrase in case the ", {
          cause: eWithPassphrase
        });
      }
    } else {
      throw new Error("Can't create private key object. Possibly because the key is encrypted so a passphrase was needed but none was provided or it was malformed.", {
        cause: e
      });
    }
  }
...
var hs256Verify = function hs256Verify(jwt, passphrase, passphraseEncoding) {
  ...
  var isVerified = base64URLHmacked === signature;
